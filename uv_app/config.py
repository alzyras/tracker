...
MATCH_THRESHOLD = 0.55       # Face recognition match threshold (lower = stricter)
CANDIDATE_THRESHOLD = 0.5    # Threshold for considering as candidate (stricter than match)
RESIZE_MAX = 640             # Max frame size for faster processing
VERBOSE_TRACKING = True      # Show detailed tracking messages
# ----------------------------------------
