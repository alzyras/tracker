...
# Add the project root directory to sys.path to ensure we can import uv_app modules
...
try:
    ...
    # If that fails, try direct path manipulation
    plugins_path = project_root / "uv_app" / "plugins"
    config_path = project_root / "uv_app"
    ...
    try:
        ...
        plugins_spec = importlib.util.spec_from_file_location(
            "plugins", 
            project_root / "uv_app" / "plugins" / "__init__.py"
        )
